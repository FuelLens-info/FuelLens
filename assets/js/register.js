...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add setLoadingState function to handle loading state on submit button
    function setLoadingState(button, isLoading) {
        if (!button) return;
        if (isLoading) {
            button.disabled = true;
            button.innerHTML = 'Creating Account... <i class="fas fa-spinner fa-spin"></i>';
        } else {
            button.disabled = false;
            button.innerHTML = 'Create Account <i class="fas fa-user-plus"></i>';
        }
    }
    ...
    function updatePasswordStrengthIndicator(strength) {
        ...
        const strengthTextElem = indicator.querySelector('.strength-text');
        strengthTextElem.style.cssText = `
            font-size: 12px;
            font-weight: 500;
    ...
    // Add showSuccessMessage function to display a success message
    function showSuccessMessage(message) {
        ...
        msgDiv.style.cssText = `
            ...
            z-index: 1000;
        `;
        msgDiv.innerHTML = `<i class="fas fa-check-circle" style="margin-right:8px"></i> ${message}`;
